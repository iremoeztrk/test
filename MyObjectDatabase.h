...
MyProperties Cube_CoarseFoam(		"DisplayImage_CoarseFoam.JPG",		"MacroImage_CoarseFoam.JPG",		"CoarseFoam",	 "Test1.wav",		a/2*cVector3d(0.30, 0.20, 0.04), MyOrientation{ cVector3d(0.0, 0.0, 0.0), 0.0 }, MyShape(cube),		3, 0.2,		0.6, 0.6, 0.0,		1.0, 1.0, 0.0);
MyProperties Cube_FineFoam("DisplayImage_Sponge.JPG", "MacroImage_Sponge.JPG", "FineFoam", "TactileSignal_Move_Sponge.wav", a / 2 * cVector3d(0.30, 0.20, 0.04), MyOrientation{ cVector3d(0.0, 0.0, 0.0), 0.0 }, MyShape(cube), 1, 0.2,  0.6, 0.6, 0.0,  1.0, 1.0, 0.0);
MyProperties Cube_GraniteTile("DisplayImage_GraniteTile.JPG", "MacroImage_GraniteTile.JPG", "GraniteTile", "TactileSignal_Tap_GraniteTile.wav", a/2*cVector3d(0.30, 0.20, 0.04), MyOrientation{ cVector3d(0.0, 0.0, 0.0), 0.0 }, MyShape(cube), 1, 0.2,  0.2, 0.2, 0.0, 1.0, 1.0, 0.0);
MyProperties Cube_CO("DisplayImage_CeramicTile.JPG", "MacroImage_CeramicTile.JPG", "CO", "TactileSignal_Tap_CoarseFoam.wav", a / 2 * cVector3d(0.30, 0.20, 0.04), MyOrientation{ cVector3d(0.0, 0.0, 0.0), 0.0 }, MyShape(cube), 3, 0.2, 0.2, 0.2, 0.0, 1.0, 1.0, 0.0);
MyProperties Cube_Steinwolle("DisplayImage_Plastic.JPG", "MacroImage_Plastic.JPG", "Steinwolle", "TactileSignal_Tap_CoarseFoam.wav", a / 2 * cVector3d(0.30, 0.20, 0.04), MyOrientation{ cVector3d(0.0, 0.0, 0.0), 0.0 }, MyShape(cube), 3, 0.2, 0.4, 0.4, 0.0, 1.0, 1.0, 0.0);
